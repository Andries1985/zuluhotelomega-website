...
`;
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\twbs\bootstrap@v5.3.3+incompatible\js\src\scrollspy.js
  var NAME7 = "scrollspy";
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\giscus@v0.1.1\assets\mods\giscus\js\index.ts
  var Giscus = class {
    setTheme(theme) {
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hbstack\giscus@v0.1.1\assets\hb\modules\giscus\js\index.ts
  (() => {
    "use strict";
  ...
  var blog = { archives: { paginate: 30 }, full_width: false, home: { backgroundimage: "/images/background.jpg", featured_posts: 5, main_sections: null, pinned_posts_position: "list", taxonomies: false }, list_cols_lg: 1, list_cols_md: 1, list_style: "", paginate: 12, post_date_format: ":date_long", post_thumbnail: true, post_thumbnail_default: "images/thumbnail.png", post_thumbnail_height: "160px", post_thumbnail_placeholder: "HB THEME", post_thumbnail_position: "top", post_thumbnail_resize_height: 360, related_posts: { number: 10 }, sidebar: { max_width: "320px", position: "start", posts: { featured_count: 5, fill: true, list_style: "slide", recent_count: 5, style: "pills" }, profile: { avatar: "/images/logo.png", avatar_size: 100, company: "", description: "", location: "", socials: { discord: "https://discord.gg/X6TWp76" }, title: "" }, sticky: true, taxonomies: { count: true, limit: 10, separate: false }, width: 0.35 }, social_share_buttons: { media: [] }, toc: { position: "end" } };
  ...
  var footer = { socials: { _color: true, discord: "https://discord.gg/X6TWp76" } };
  var full_width = false;
  var full_width_types = { docs: { enable: true } };
  var google_fonts = { display: "swap" };
  var header = { brand: "Zuluhotel Omega", breakpoint: "lg", full_width: true, socials: { discord: "https://discord.gg/X6TWp76" }, sticky: true, theme_toggle: { style: "switch" } };
