(() => {
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\krisk\!fuse@v7.0.0+incompatible\dist\fuse.js
  var require_fuse = __commonJS({
    "ns-hugo:C:\\Users\\admin\\AppData\\Local\\hugo_cache\\modules\\filecache\\modules\\pkg\\mod\\github.com\\krisk\\!fuse@v7.0.0+incompatible\\dist\\fuse.js"(exports, module) {
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\keyboard.ts
  var Keyboard = class {
    keys = {};
    events = [];
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\navigator.ts
  var Navigator = class {
    modal() {
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\i18n.ts
  var i18n = void 0;
  var init = () => {
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\engine.ts
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\historiographer.ts
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\form.ts
  var Form = class {
...
<button class="search-panel-action search-expand-toggle${params_default.expand_results_meta ? " active" : ""}" title="Expand">
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\spinner.ts
  var Spinner = class {
    constructor(ele) {
      this.ele = ele;
    }
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\renderer.ts
  var Renderer = class {
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\shortcuts.ts
  var Navigate = () => {
    return {
      kbds: ["\u2191", "\u2193"],
...
<span class="search-shortcut-action">${shortcut["action"]}</span>
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\modal.ts
  var searchShortcut = () => {
    return {
  ...
  // ns-hugo:C:\Users\admin\AppData\Local\hugo_cache\modules\filecache\modules\pkg\mod\github.com\hugomods\search@v0.18.3\assets\search\js\search.ts
  var Search = class {
    container;
    form;
    shortcuts;
