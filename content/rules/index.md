---
title: Rules
description: "Zuluhotel Omega has rules. Be sure to read them carefully."
...
## Bugs/Hacks/Cheats/Exploits/Loopholes
- Using, abusing, or failing to report an error in the game which may give unintentional benefits will not go unnoticed for long, and may in return see you permanently lose stats, skills, characters or accounts depending on the severity of the bug abuse. 
- If you find any exploitable bug, please report it immediately with either the in-game help system or PM Nagash the details of the bug. Not doing so will be severely punished.
...
## Ghosting
What does “Ghosting” mean? It basically means that placing a stationary character in front or inside a dungeon or other points of interest(only NPC related points of interest) to observe when someone is entering a place such as a dungeon is illegal.

By doing this you will be able to easily avoid confrontation with other players by abusing a second character as a dummy. Anyone caught doing this will receive punishment. 

<u>Scouting with a geared character that you actually play with is totally fine.</u>
...
<u>In short using your character as a camera is forbidden.</u>
...
- Yards should not be placed to block passages, roads, entrances, caves or mines with any items that cannot be removed by other players. Doing so will get your yard removed without warning. This may also result in jail time!
...
## No PK/loot Zones
The zones are: 
- Ocllo, Vendor Market, Jail and Star Room.
...
- Placing items to block players from leaving or entering points of interest or prevent access to any public area is not allowed. 
- Placing items to create a yard is fine as long as it doesn’t obstruct points of interest.
