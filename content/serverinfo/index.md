---
title: Server Info
description: "General server and shard information."
...
>TIP: Pick two other skills that start at 50 and one other stat set to 60 when creating a character.

## Loot
The loot has received a bunch of changes and the ways to get “good” loot has been made more difficult. For example we no longer have SoS bottles. 

High-level treasure map spots will be located inside dungeons. 

Most of the bosses have been randomized (which means you will not be able to lure that behemoth to the water every time). 

### Loot group changes
The NPC’s have been reworked in terms of loot and have been assigned proper loot groups. 

The chance for Power and Vanquishing weapons is fair while Devastation is more difficult. Still there’s always that lucky drop.
...
---
Q: Can I donate for items or other benefits?

A: Voluntary donations that help pay for server and website costs are appreciated.

Know that you will receive **<u>no benefits</u>** other than our heartfelt thanks for helping us keep this server and website operational.

>Paypal: Donate [**here**](https://paypal.me/ZuluhotelOmega)!